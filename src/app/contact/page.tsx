        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4 border-b border-slate-300 dark:border-blue-900/30 pb-3">
              ...
              <code className="text-xs text-slate-700 dark:text-slate-500 font-mono ml-2">~/contact_form</code>
            </div>
            
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="form-control">
                <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-slate-300 font-mono">
                  name:
                </label>
                <input 
                  type="text" 
                  ...
                  className="w-full px-4 py-2 rounded-md bg-white dark:bg-slate-800/80 border border-slate-300 dark:border-blue-900/30 text-slate-900 dark:text-slate-200 focus:outline-none focus:border-blue-700 dark:focus:border-cyan-500/50 focus:ring-1 focus:ring-blue-700 dark:focus:ring-cyan-500/50 font-mono placeholder:text-slate-500 dark:placeholder:text-slate-600 placeholder:font-mono shadow-sm" 
              ...
              {formStatus === 'success' && (
                <div className="mt-4 p-3 rounded-md bg-green-50 dark:bg-slate-800/80 border border-green-200 dark:border-green-900/30 text-green-800 dark:text-green-400 font-mono text-sm">
                  <p>// Success! Your message has been received.</p>
                </div>
              )}
              
              {formStatus === 'error' && (
                <div className="mt-4 p-3 rounded-md bg-red-50 dark:bg-slate-800/80 border border-red-200 dark:border-red-900/30 text-red-800 dark:text-red-400 font-mono text-sm">
