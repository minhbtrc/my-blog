  ...
  return (
    <BlogPostStyle
      ...
      coverImage={{
        ...
        alt: "Terminal-inspired blog homepage",
        caption: "Terminal-inspired homepage with profile photo and theme toggle"
      }}
      author={{
        name: "MinhBTC",
    ...
    >
      ...
      <section className="mb-16 relative">
        <div className="absolute left-0 top-1/2 w-12 h-12 border-l-2 border-t-2 border-border -ml-6 -mt-6"></div>
        ...
        <div className="font-mono text-sm bg-muted/50 p-5 rounded-md mb-6 border-l-4 border-primary shadow-sm">
          <span className="text-primary font-bold">{`>`}</span> Quick spoiler: It involved a lot of help from my AI friends.
        </div>

        <p className="mb-6 text-muted-foreground text-lg leading-relaxed">
          I live for FastAPI & Backend Architecture, Embeddings & Vector Databases, LangChain & LlamaIndex, and Token Optimizations & OpenAI APIs. Graphs are beautiful. <span className="font-semibold text-primary">CSS flexbox and gradients are nightmares I'd rather delegate to the void.</span>
        </p>
      ...
      <section className="mb-16 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="border-l-4 border-green-500 pl-6 py-4 hover:bg-muted/30 transition-colors rounded-r-md group">
            <h3 className="text-xl font-semibold mb-3 text-foreground group-hover:text-green-600 transition-colors">
              Framework
            </h3>
          ...
          <div className="border-l-4 border-blue-500 pl-6 py-4 hover:bg-muted/30 transition-colors rounded-r-md group">
            <h3 className="text-xl font-semibold mb-3 text-foreground group-hover:text-blue-600 transition-colors">
              Styling
            </h3>
            <p className="text-muted-foreground mb-2 leading-relaxed">
          ...
          <div className="border-l-4 border-purple-500 pl-6 py-4 hover:bg-muted/30 transition-colors rounded-r-md group">
            <h3 className="text-xl font-semibold mb-3 text-foreground group-hover:text-purple-600 transition-colors">
              Editor
            </h3>
            <p className="text-muted-foreground mb-2 leading-relaxed">
          ...
          <div className="border-l-4 border-amber-500 pl-6 py-4 hover:bg-muted/30 transition-colors rounded-r-md group">
            <h3 className="text-xl font-semibold mb-3 text-foreground group-hover:text-amber-600 transition-colors">
              Design Co-pilot
            </h3>
            <p className="text-muted-foreground mb-2 leading-relaxed">
          ...
          <div className="border-l-4 border-teal-500 pl-6 py-4 hover:bg-muted/30 transition-colors rounded-r-md group">
            <h3 className="text-xl font-semibold mb-3 text-foreground group-hover:text-teal-600 transition-colors">
              Deployment
            </h3>
        ...
        <div className="p-6 bg-muted/30 rounded-lg mb-6 shadow-sm border border-border">
          <h4 className="text-xl font-semibold mb-4 text-foreground flex items-center">
            <Code size={18} className="mr-2 text-red-500" />
        ...
        <div className="font-mono text-sm text-muted-foreground border-l-4 border-muted-foreground/50 pl-6 py-4 italic bg-muted/30 rounded-r-md">
      ...
      <section className="mb-16">
        ...
        <div className="mb-8 relative">
          ...
          <h3 className="text-2xl font-semibold mb-6 text-foreground inline-block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            The AI-Powered Dev Loop
          </h3>

          <ol className="space-y-6 mb-8 pl-6 list-decimal">
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">I write something basic—hero, card, nav. I highlight the ugly bits and pray Cursor knows how to Tailwind better than I do.</p>
            </li>
            ...
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Hit refresh. Embrace reality. It's always underwhelming, which is great—low expectations fuel innovation.</p>
            </li>
            ...
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Capture my mediocrity in full HD.</p>
            </li>
            ...
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Drop the screenshot into GPT-4o with desperate pleas like: "Make this look less terrible, more hacker-chic."</p>
            </li>
            ...
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">GPT-4o generously provides precise, actionable tips:</p>
              <div className="font-mono text-sm text-muted-foreground mt-3 pl-5 border-l-2 border-blue-400 py-2 bg-blue-50 dark:bg-blue-900/20 rounded-r-md">
            ...
            <li className="bg-card p-5 rounded-lg shadow-sm border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Rinse, refresh, repeat. It feels like pair programming with a super talented designer who doesn't judge my lack of CSS prowess.</p>
            </li>
          </ol>

          <div className="bg-muted/30 p-6 rounded-lg shadow-sm border border-border">
            <h4 className="text-xl font-semibold mb-4 text-foreground flex items-center">
            ...
            <ul className="space-y-4 pl-6 list-disc">
              <li className="text-muted-foreground leading-relaxed">
                <strong className="font-semibold text-primary">Immediate Gratification:</strong> No context switches. Just me, my AI duo, and immediate feedback.
              </li>
              <li className="text-muted-foreground leading-relaxed">
                <strong className="font-semibold text-primary">No Guesswork:</strong> GPT-4o provides ultra-specific, practical advice—no more CSS existential dread.
              </li>
              <li className="text-muted-foreground leading-relaxed">
                <strong className="font-semibold text-primary">Stealth Learning:</strong> Iterative AI feedback subtly trained my eye. Now I catch myself saying, "Hmm, that's not aligned" before GPT does.
              </li>
              <li className="text-muted-foreground leading-relaxed">
                <strong className="font-semibold text-primary">Infinite Availability:</strong> GPT-4o is my midnight companion who never complains or files HR reports.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="mb-16 relative">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-semibold mb-4 text-foreground inline-block bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm mb-8 border border-border">
            ...
            <ul className="pl-6 list-disc mb-4 text-muted-foreground space-y-2">
          ...
          <h3 className="text-2xl font-semibold mb-4 text-foreground inline-block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            GPT-4o Suggestions
          </h3>

          <div className="bg-muted/30 p-6 rounded-lg shadow-sm mb-8 border border-border">
            <p className="mb-4 text-muted-foreground leading-relaxed">
              After showing GPT-4o a screenshot, it suggested:
            </p>

            <ul className="pl-6 list-disc mb-0 space-y-2">
              <li className="text-muted-foreground leading-relaxed">Add spacing and padding for breathing room</li>
              <li className="text-muted-foreground leading-relaxed">Improve typography with font weight variations</li>
              <li className="text-muted-foreground leading-relaxed">Include subtle background styling</li>
              <li className="text-muted-foreground leading-relaxed">Add hover effects to the button</li>
              <li className="text-muted-foreground leading-relaxed">Incorporate a visual element or subtle pattern</li>
            </ul>
          </div>

          <h3 className="text-2xl font-semibold mb-4 text-foreground inline-block bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed border-l-4 border-amber-500 pl-6 py-4 bg-amber-50 dark:bg-amber-900/20 rounded-r-md">
      ...
      <section className="mb-16 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="border-l-4 border-blue-500 pl-6 py-4 bg-card shadow-sm rounded-md border-y border-r border-border">
          ...
          <div className="border-l-4 border-purple-500 pl-6 py-4 bg-card shadow-sm rounded-md border-y border-r border-border">
            <h3 className="text-xl font-semibold mb-3 text-foreground flex items-center">
        ...
        <div className="bg-muted/30 p-6 rounded-lg shadow-sm mb-8 border border-border">
          <p className="mb-3 text-muted-foreground leading-relaxed text-lg">
        ...
        <blockquote className="border-l-4 border-green-500 pl-6 py-4 bg-green-50 dark:bg-green-900/20 rounded-r-md mb-6">
          ...
          <footer className="text-right mt-4 text-muted-foreground">— A moment of unexpected wisdom</footer>
        </blockquote>
      </section>
      ...
      <section className="mb-16 relative">
        ...
        <div className="border border-border rounded-xl bg-muted/30 p-6 mb-10 shadow-sm">
          {/* Top row with 3 components */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-card p-6 rounded-lg shadow-sm border-t-4 border-blue-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-x border-b border-border">
              <h3 className="text-xl font-bold mb-3 text-foreground flex items-center">
                <Code size={20} className="mr-3 text-blue-500 flex-shrink-0" />
                Code Editor
              </h3>
              <p className="text-muted-foreground leading-relaxed">Code changes trigger automatic renders in development server</p>
            </div>

            <div className="bg-card p-6 rounded-lg shadow-sm border-t-4 border-purple-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-x border-b border-border">
              <h3 className="text-xl font-bold mb-3 text-foreground flex items-center">
                <Monitor size={20} className="mr-3 text-purple-500 flex-shrink-0" />
                UI Renderer
              </h3>
              <p className="text-muted-foreground leading-relaxed">Captures screenshots at set intervals or on significant changes</p>
            </div>

            <div className="bg-card p-6 rounded-lg shadow-sm border-t-4 border-green-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-x border-b border-border">
              <h3 className="text-xl font-bold mb-3 text-foreground flex items-center">
                <Zap size={20} className="mr-3 text-green-500 flex-shrink-0" />
                Local Agent
              </h3>
              <p className="text-muted-foreground leading-relaxed">Orchestrates the flow between components</p>
            </div>
          </div>

          {/* GPT-4o Analysis with improved visual styling */}
          <div className="bg-muted/30 p-6 rounded-lg shadow-sm mb-6 border border-border hover:border-primary transition-colors">
            <h3 className="text-xl font-bold mb-4 text-foreground flex items-center">
              <Eye size={20} className="mr-3 text-blue-500 flex-shrink-0" />
              GPT-4o Analysis
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-foreground">Evaluates UI</p>
                  <p className="text-sm text-muted-foreground">Analyzes screenshots visually</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-foreground">Suggests improvements</p>
                  <p className="text-sm text-muted-foreground">Provides actionable feedback</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-foreground">Generates code</p>
                  <p className="text-sm text-muted-foreground">Creates implementation fixes</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card p-6 rounded-lg shadow-sm border-l-4 border-blue-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-y border-r border-border">
            <h4 className="text-xl font-bold mb-3 text-foreground flex items-center">
              <Eye size={20} className="mr-3 text-blue-500 flex-shrink-0" />
              Visual Context {'>'} Text
            </h4>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm border-l-4 border-purple-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-y border-r border-border">
            <h4 className="text-xl font-bold mb-3 text-foreground flex items-center">
              <ArrowRight size={20} className="mr-3 text-purple-500 flex-shrink-0" />
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm border-l-4 border-green-500 hover:translate-y-[-2px] transition-all duration-200 h-full border-y border-r border-border">
            <h4 className="text-xl font-bold mb-3 text-foreground flex items-center">
              <BookOpen size={20} className="mr-3 text-green-500 flex-shrink-0" />
      ...
      <section className="mb-16 relative">
        ...
        <div className="bg-card p-6 rounded-lg shadow-sm mb-8 border border-border">
          <ul className="mb-0 space-y-4 pl-6 list-disc">
            <li className="text-muted-foreground leading-relaxed text-lg">You don't need design skills; you just need AI patience.</li>
            <li className="text-muted-foreground leading-relaxed text-lg">Screenshots beat text prompts for UI. GPT sees what your words can't describe.</li>
            <li className="text-muted-foreground leading-relaxed text-lg">Building alongside AI isn't just efficient—it's genuinely fun.</li>
            <li className="text-muted-foreground leading-relaxed text-lg">The barrier between backend and frontend is blurrier than my eyesight at 3 AM (in a good way).</li>
          </ul>
        </div>

        <p className="text-xl mb-8 text-muted-foreground leading-relaxed bg-muted/30 p-6 rounded-lg shadow-sm border border-border">
          To every dev who's ever felt "I'm terrible at frontend": Try this loop. It's like discovering cheat codes for real life.
        </p>

        <div className="border-l-4 border-amber-500 pl-6 py-6 bg-card rounded-md shadow-sm mb-8 border-y border-r border-border">
          <p className="font-semibold text-xl mb-4 text-foreground flex items-center">
            <BookOpen size={18} className="mr-2 text-amber-500" />
            Coming Soon:
          </p>
          <ul className="space-y-2 pl-6 list-disc text-muted-foreground">
        ...
        <p className="italic text-lg text-muted-foreground mb-6 leading-relaxed">
